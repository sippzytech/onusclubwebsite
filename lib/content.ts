export const PRICE = 'PRICE' // TODO: replace with actual price
...
export const FEATURES = [
  {
    ...
    p: "Your customers will never install an app for a coffee. The card lives where they already keep their boarding passes.",
  },
  {
  ...
  },
  {
    ...
    p: 'A clean staff dashboard that adds a stamp in one tap. No training, no extra hardware, no slowing down the queue.',
  },
  {
...
export const INVERT = {
  eyebrow: 'Paper cards & clunky apps, retired',
  h2: 'The same loyalty idea, without the friction nobody wanted.',
  cols: [
    {
